...
const _i = (p, c) => `<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"${c ? ` style="color:${c}"` : ""}>${p}</svg>`;
...
const ICON = {
  ...
  home: _i('<path d="M3 7.6 8 3.3l5 4.3"/><path d="M4.4 7V12.7h7.2V7"/>', "#6ba6ff"),
  sliders: _i('<path d="M3 5.2h5M11.6 5.2H13M3 10.8h1.4M7.6 10.8H13"/><circle cx="9.8" cy="5.2" r="1.6"/><circle cx="5.2" cy="10.8" r="1.6"/>', "#8b7cf6"),
  clock: _i('<circle cx="8" cy="8" r="5.6"/><path d="M8 5.2V8l2.2 1.5"/>', "#f0b445"),
  chart: _i('<path d="M3 3v10h10"/><path d="M5.5 9.6 8 7l1.8 1.8L13 4.9"/>', "#3ecf8e"),
  compass: _i('<circle cx="8" cy="8" r="5.6"/><path d="m10.3 5.7-1.5 3.1-3.1 1.5 1.5-3.1z"/>', "#e57ab1"),
  wallet: _i('<rect x="2.4" y="4.4" width="11.2" height="8" rx="1.8"/><path d="M2.4 6.9h11.2"/><path d="M11 9.7h.01"/>', "#56b4d3"),
  flag: _i('<path d="M4 13.6V2.8"/><path d="M4 3.2h6.8L9.2 5.9l1.6 2.7H4"/>', "#f0b445"),
  trend: _i('<path d="M2.5 11.5 6.5 7.4l2.5 2.5 4.5-5"/><path d="M10.3 4.9h3.2v3.2"/>', "#5ee3ab"),
  cal: _i('<rect x="2.8" y="3.4" width="10.4" height="9.6" rx="1.6"/><path d="M2.8 6.6h10.4M5.8 2.2v2M10.2 2.2v2"/>', "#6aa9e9"),
  tag: _i('<path d="M2.6 7V3.4a.8.8 0 0 1 .8-.8H7a1 1 0 0 1 .7.3l5.3 5.3a1 1 0 0 1 0 1.4l-3.7 3.7a1 1 0 0 1-1.4 0L2.9 7.7a1 1 0 0 1-.3-.7z"/><path d="M5.7 5.7h.01"/>', "#c07af0"),
  banknote: _i('<rect x="2.2" y="4.6" width="11.6" height="6.8" rx="1.4"/><circle cx="8" cy="8" r="1.7"/><path d="M4.5 8h.01M11.5 8h.01"/>', "#3ecf8e"),
  cart: _i('<path d="M2.6 3.4h1.6l1.5 6.6h5.9l1.8-4.9H4.8"/><circle cx="6.3" cy="12.7" r=".9"/><circle cx="10.9" cy="12.7" r=".9"/>', "#ef9366"),
  check: _i('<path d="m3.4 8.6 2.9 2.9 6.3-7"/>', "#3ecf8e"),
  scales: _i('<path d="M5.3 12.6V3.4M5.3 3.4 3.2 5.5M5.3 3.4l2.1 2.1"/><path d="M10.7 3.4v9.2m0 0 2.1-2.1m-2.1 2.1-2.1-2.1"/>', "#8b7cf6"),
  upload: _i('<path d="M8 10.6V3.2M8 3.2 5.4 5.8M8 3.2l2.6 2.6"/><path d="M3 12.8h10"/>', "#6ba6ff"),
  list: _i('<path d="M5.8 4.4h7.4M5.8 8h7.4M5.8 11.6h7.4"/><path d="M2.8 4.4h.01M2.8 8h.01M2.8 11.6h.01"/>', "#93a0b4"),
  filter: _i('<path d="M2.6 3.4h10.8L9.6 8.3v3.8l-3.2 1.5V8.3z"/>', "#e3bb56"),
  file: _i('<path d="M4 2.6h4.9L12 5.7v7.7H4z"/><path d="M8.7 2.8V6h3.1"/>', "#6aa9e9"),
  layers: _i('<path d="m8 2.8 5.6 3L8 8.8l-5.6-3z"/><path d="M2.4 9.2 8 12.2l5.6-3"/>', "#3ecf8e"),
  lock: _i('<rect x="3.8" y="7" width="8.4" height="6" rx="1.4"/><path d="M5.6 7V5.4a2.4 2.4 0 0 1 4.8 0V7"/>', "#f0b445"),
  bank: _i('<path d="M2.6 6.2 8 3l5.4 3.2"/><path d="M3.7 6.5v4.3M8 6.5v4.3M12.3 6.5v4.3"/><path d="M2.6 13h10.8"/>', "#6ba6ff"),
  droplet: _i('<path d="M8 2.8c2.1 2.5 3.6 4.3 3.6 6.1a3.6 3.6 0 1 1-7.2 0C4.4 7.1 5.9 5.3 8 2.8z"/>', "#56b4d3"),
};
